...
class YOWO(nn.Module):
    ...
    def __init__(self, opt):
        ...
        self.conv_final_class = nn.Conv2d(1024, 5 * (1 + opt.n_classes), kernel_size=1, bias=False)
        self.conv_final_region = nn.Conv2d(1024, 5 * 4, kernel_size=1, bias=False)
    ...
    def forward(self, input):
        ...
        out = torch.cat((out_r, out_c), dim=2)
