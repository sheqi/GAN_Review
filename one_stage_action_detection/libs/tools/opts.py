...
def parse_opts():
    ...
    parser.add_argument('--check_name', default='', help='check_name')
    parser.add_argument('--test_video_list', default='', help='test_video_list')
    parser.add_argument('--is_vis', default=False, type=bool, help='save box result')
