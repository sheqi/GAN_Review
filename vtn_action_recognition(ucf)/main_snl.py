...
from action_recognition.utils import (
    ...
    create_code_snapshot, mkdir_if_not_exists, print_git_revision, generate_args)
...
def get_fine_tuning_parameters(model, ft_begin_index):
    ...
    ft_module_names = []
    for i in range(ft_begin_index, 8):
        ft_module_names.append('resnet{}'.format(i))
    ft_module_names.append('resnet.6.5.stages')
    #ft_module_names.append('self_attention_decoder')
...
###########################
    #parameters = get_fine_tuning_parameters(model, 9)
###########################
